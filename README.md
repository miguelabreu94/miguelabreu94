...
Although I am a recent graduate and do not have direct experience in the industry, my academic background has equipped me with a solid foundation in key IT concepts, including Object Oriented Programming (Java), Service Oriented Architecture, Spring Boot, Data, Security, DB and SQL Fundamentals (PostgreSQL specifically), Unit Testing and Integration and Delivery. During my studies, I completed projects that required problem-solving, critical thinking, and collaboration—skills that I believe are essential for success in the IT field.
